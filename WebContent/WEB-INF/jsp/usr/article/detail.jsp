					...
					<tr data-id="${reply.id}" >
						...
						<td>
							<div class="btn-wrap">
								...
								<a class="btn btn-danger" onclick="if ( confirm('정말 삭제하시겠습니까?') == false ) { return false; }" href="../reply/doDelete?id=${reply.id}&redirectUrl=${encodedCurrentUrl}">삭제</a>
							</div>
						</td>
						<td>
						...
						<td class="visible-sm-down">
							...
							<div class="flex">
								...
								<span>&nbsp;|&nbsp;</span>
								<span class="response-list-box__reg-date response-list-box__reg-date--mobile">${reply.regDate}</span>
							</div>
							<div class="btn-wrap">
								<a class="btn btn-info" href="../reply/modify?id=${reply.id}&redirectUrl=${encodedCurrentUrl}">수정</a>
